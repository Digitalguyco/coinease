        ...
        <div className="flex flex-col md:flex-row gap-10 md:gap-6 lg:gap-10">
          ...
          <div className="flex flex-col gap-4 max-w-full md:max-w-[214px]">
            <div className="text-center md:text-left">
              <span className="text-[#000001] text-xl sm:text-[22px] font-bold font-['Exo'] leading-snug">
                {" "}
              </span>
              <span className="text-[#1d2d3f] text-xl sm:text-[22px] font-bold font-['Exo'] leading-snug">
                Coin
              </span>
              <span className="text-[#5b46f6] text-xl sm:text-[22px] font-bold font-['Exo'] leading-snug">
                Ease
              </span>
            </div>
          ...
          <div className="flex flex-col gap-4 md:ml-4">
            <div className="text-center md:text-left">
              <span className="text-[#2c4569] text-lg sm:text-[22px] font-semibold font-['Inter']">
                I
              </span>
              <span className="text-[#2c4569] text-lg sm:text-[22px] font-semibold font-['Inter'] lowercase">
                MPORTANT LINKS
              </span>
            </div>
            <ul className="flex flex-col gap-2 text-center md:text-left">
              ...
              <li className="hover:text-[#5b46f6] cursor-pointer">
                Contact Us
              </li>
              <li className="hover:text-[#5b46f6] cursor-pointer">
                Get Started
