...
export default function Deposit() {
  ...
  const handlePaymentConfirmation = () => {
    ...
    // Simulate blockchain verification (in a real app, this would call your backend)
    setTimeout(() => {
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6 mb-6">
                {currentStep === 1 && (
                  <div className="flex flex-col space-y-6">
                    <h2 className="text-lg font-semibold">Enter Deposit Amount</h2>
                    <form onSubmit={handleAmountSubmit} className="space-y-6">
                      <div className="flex flex-col space-y-2">
                        <label htmlFor="depositAmount" className="text-sm font-medium text-gray-700 dark:text-gray-300">
                          Amount
                        </label>
                ...
                {currentStep === 2 && (
                  <div className="flex flex-col space-y-6">
                    <h2 className="text-lg font-semibold">Select Payment Network</h2>
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      You are depositing <span className="font-semibold">${depositAmount}</span>. Select the cryptocurrency network you would like to use for your deposit.
                    </p>
                      ...
                      {Object.keys(cryptoAddresses).map((network) => (
                        ...
                        >
                          ...
                          <div className="flex-1">
                            <h3 className="font-medium">{networkNames[network as keyof typeof networkNames]}</h3>
                            <p className="text-xs text-gray-500 dark:text-gray-400">Network fee: ~$2-5</p>
                          </div>
                  ...
                  <div className="flex flex-col space-y-6">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-700 p-4 rounded-lg">
                      <p className="text-sm mb-4">
                        Please send <span className="font-bold">${depositAmount}</span> worth of {networkNames[selectedNetwork as keyof typeof networkNames]} to the address below:
                      </p>
                        ...
                        <div className="md:w-2/3 break-all">
                          <div className="flex flex-col space-y-2">
                            <label className="text-xs font-medium text-gray-500 dark:text-gray-400">
                              {cryptoAddresses[selectedNetwork as keyof typeof cryptoAddresses]} Address
                            </label>
                            <div className="flex items-center">
                              ...
                              <button
                                onClick={() => copyToClipboard(cryptoAddresses[selectedNetwork as keyof typeof cryptoAddresses])}
                        ...
                        <div className="flex items-start">
                          ...
                          <div className="ml-3">
                            ...
                            <ul className="mt-1 list-disc list-inside text-yellow-700 dark:text-yellow-300">
                              <li>Send only {selectedNetwork.toUpperCase()} to this address</li>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
                ...
                <ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                  <li className="flex items-start">
                    ...
                    Deposits are typically credited within 30 minutes after network confirmation.
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 w-5 h-5 text-[#5B46F6] mr-2">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    The exchange rate will be calculated at the time of deposit confirmation.
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 w-5 h-5 text-[#5B46F6] mr-2">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    Double check the network type before sending funds to avoid loss.
                  </li>
                  <li className="flex items-start">
                    <div className="flex-shrink-0 w-5 h-5 text-[#5B46F6] mr-2">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-sm w-full mx-4">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Your deposit of ${depositAmount} has been confirmed and added to your account.
              </p>
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl p-6 max-w-sm w-full mx-4">
            <div className="flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-semibold mb-2">Deposit Not Found</h3>
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                We couldn&apos;t verify your payment. If you&apos;ve already made the payment, it might take some time to be confirmed on the blockchain.
              </p>
              <div className="flex gap-3 w-full">
                <button
                  onClick={resetProcess}
